...
public class Golem extends Personagens implements Lutador {
	
	private Itens item;

	public Golem() {
		super("", 4100, 80, 100, 50, 120, 3, null, true);
	}

	public Golem(String nome) {
		super(nome, 4100, 80, 100, 30, 120, 3, null, true);

	}
	
	

	public Golem(Itens item) {
		super("", 4100, 80, 30, 50, 80, 3, null, true);
		this.item = item;
	}
